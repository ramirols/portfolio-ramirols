...
export default function Mantenimiento() {
    ...
    return (
        <>
            <ClientOnly>
                <NextSeo
                    title="Página en mantenimiento | Ramiro Ls"
                    description="Estamos mejorando tu experiencia, vuelve pronto."
                    canonical="https://portfolio-ramirols.vercel.app/mantenimiento"
                    openGraph={{
                        url: 'https://portfolio-ramirols.vercel.app/mantenimiento',
                        title: 'Página en mantenimiento | Ramiro Ls',
                        description: 'Estamos mejorando tu experiencia, vuelve pronto.',
                        images: [
                            {
                ...
                {isLoading ? (
                    <div className="flex items-center justify-center h-screen">
                        <Skeleton className="w-full h-full" count={10} />
                    </div>
                ) : (
                    <main
                        ref={mainRef}
                    ...
                    >
                        ...
                        <section className="h-screen flex items-center justify-center p-4 relative z-10">
                            ...
                            >
                                ...
                                >
                                    <h1 className="text-white/90 text-base md:text-xl">Ramiro Ls | Desarrollador de Software</h1>
                                </motion.div>
